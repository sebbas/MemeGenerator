...
public class MemeChildFragmentThree extends RecyclerFragment {

    public static final String TAG = "MemeChildFragmentThree";

    private SuperSlimRecyclerAdapter mSuperSlimRecyclerAdapter;

    public static MemeChildFragmentThree newInstance(int layoutMode, boolean isRefreshable, int position) {
        MemeChildFragmentThree fragment = new MemeChildFragmentThree();
