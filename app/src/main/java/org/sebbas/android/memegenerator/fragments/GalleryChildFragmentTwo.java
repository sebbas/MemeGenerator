...
public class GalleryChildFragmentTwo extends RecyclerFragment {

    public static final String TAG = "GalleryChildFragmentTwo";

    public static GalleryChildFragmentTwo newInstance(int layoutMode, boolean isRefreshable, int position) {
        GalleryChildFragmentTwo fragment = new GalleryChildFragmentTwo();
