...
public class MemeChildFragmentTwo extends RecyclerFragment {

    public static final String TAG = "MemeChildFragmentTwo";

    public static MemeChildFragmentTwo newInstance(int layoutMode, boolean isRefreshable, int position) {
        MemeChildFragmentTwo fragment = new MemeChildFragmentTwo();
