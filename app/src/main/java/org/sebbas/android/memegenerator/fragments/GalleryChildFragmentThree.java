...
public class GalleryChildFragmentThree extends RecyclerFragment {

    public static final String TAG = "GalleryChildFragmentThree";

    private SimpleRecyclerAdapter mSimpleRecyclerAdapter;

    public static GalleryChildFragmentThree newInstance(int layoutMode, boolean isRefreshable, int position) {
        GalleryChildFragmentThree fragment = new GalleryChildFragmentThree();
